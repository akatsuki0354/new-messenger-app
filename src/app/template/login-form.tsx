        ...
        <form className="flex flex-col gap-6">
            ...
            <div className="grid gap-6">
                <div className="grid gap-3">
                    ...
                    <UserCircle className="absolute mt-9 ml-2 opacity-50" />
                    <Input id="email" type="email" className="pl-10" placeholder="m@example.com" required />
                </div>
                ...
                <div className="grid gap-3">
                    ...
                    <Lock className="absolute mt-10 ml-2 opacity-50" />
                    <Input id="password" className="pl-10" type="password" placeholder="Enter your password" required />
                </div>
                ...
                <Button variant="outline" onClick={LoginForm} className="w-full">
